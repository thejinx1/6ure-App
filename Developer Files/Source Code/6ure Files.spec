...
APP_NAME = "6ure™ App"
APP_VERSION = (os.environ.get("REYLI_APP_VERSION") or os.environ.get("APP_VERSION") or "1.5.3").strip().lstrip("v")
ROOT = Path.cwd()
...
if IS_MACOS:
    app = BUNDLE(
        ...
        info_plist={
            ...
            "CFBundleShortVersionString": APP_VERSION or "1.5.3",
            "CFBundleVersion": APP_VERSION or "1.5.3",
